...
if __name__ == '__main__':
    ...
    test_l = [4, 6, 10, 28, 33, 39, 46, 47, 56, 71, 88, 116, 128, 140, 144, 154, 186, 193]
    #test_l = range(0, 1249)
    for i in test_l:
        ...
        mask, h_dots, w_dots = scan_mask(w, h, row_dist=8, col_dist=1)
        # print(w_dots)
        ...
        #cand = get_bounding_box(filter_img, mask, h_s=30, shift_by=5, box_h=75, box_w=75, threshold=0.4)

        # also pretty good - best
        cand, cand_num = get_bounding_box(filter_img, mask, h_s=20, shift_by=3, box_h=50, box_w=50, threshold=0.45)
